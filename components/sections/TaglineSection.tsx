...
export default function TaglineSection() {
  return (
    <p className="text-lg sm:text-xl text-muted-foreground leading-relaxed max-w-3xl mx-auto">
      ...
      With <span className="text-brand-400 font-semibold">8 A1s in WASSCE</span> and <span className="text-brand-400 font-semibold">Olympiad gold medals</span>, 
      I bring mathematical rigor to every engineering challenge. From hardware architecture to full-stack development, 
      I bridge the gap between silicon and software.{" "}
