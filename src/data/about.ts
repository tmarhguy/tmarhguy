...
I'm Tyrone Iras Marhguy — a Ghanaian computer engineering student at the [University of Pennsylvania](https://www.upenn.edu) on a full scholarship. I build computers from discrete transistors to tapeout and write the software to test, automate, and deploy them.

# Early Life

I was born in Ghana on November 24, 2003. I'm a triplet — my sisters are [Nikita](https://www.myjoyonline.com/siblings-of-rastafarian-refused-admission-to-achimota-school-allegedly-ordered-to-cut-their-hair-at-st-johns-grammar/) and Amrita Marhguy. We grew up between Kumasi and Accra, and for several years our family lived primarily on a parked bus.
...
The full story is documented on [Wikipedia](https://en.wikipedia.org/wiki/Tyrone_Marhguy) and in the court record for [Marhguy v. Achimota School](https://superlawgh.com/judgements/tyrone-marghuy-v-achimota-school-anor-2021-hc-high-court-%C2%B7-suit-no-hr-0055-2021-%C2%B7-31-may-2021-%C2%B7/).
...
This fall I'm joining Pennovation to research FPGA utilization, building [Tomato](https://github.com/tmarhguy/tomato) — a custom 32-bit computer from discrete logic through PCB tapeout — and shipping low-latency networking hardware in SystemVerilog. I've also built an [8-bit discrete-transistor ALU](https://alu.tmarhguy.com) from first principles. Professionally, I'm interning with [Vero Electric](https://veroelectric.com/) on battery management infrastructure and working with [Aragorn AI](https://www.aragorn.ai/) on production backends and technical documentation. I taught through [Fife-Penn STEM & CS Academy](https://fife.cis.upenn.edu/) and spent Summer 2026 as an AR/VR instructor with [Howard University STEM Achievers](https://education.howard.edu/affiliated-programs/stem-summer-camp-verizon-innovative-learning). For press coverage and a fuller biography, see my [Wikipedia article](https://en.wikipedia.org/wiki/Tyrone_Marhguy).
...
- Triplet — sisters Nikita and Amrita.
- Born in Ghana; grew up between Kumasi and Accra.
