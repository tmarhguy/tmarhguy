...
This fall I'm joining [Fluid Silicon Inc.](https://penntoday.upenn.edu/news/penn-student-develops-way-computer-chips-run-more-efficiently) at the [Pennovation Center](https://pennovation.upenn.edu) as a Hardware Research Engineer Intern: RTL design in HDL, then verification in emulation and simulation. I'm building [Tomato](https://tomato.tmarhguy.com) ([GitHub](https://github.com/tmarhguy/tomato)) — a custom 32-bit computer from discrete logic through PCB tapeout — and shipping low-latency networking hardware in SystemVerilog. I'm also a contributor to [LibreLane](https://github.com/librelane/librelane) — merged [PR #1015](https://github.com/librelane/librelane/pull/1015) gating deprecated abc -fast for Yosys ≥ 0.68, shipped as [3.0.8](https://github.com/librelane/librelane/releases/tag/3.0.8) — [OpenROAD](https://github.com/The-OpenROAD-Project/OpenROAD) ([PR #11107](https://github.com/The-OpenROAD-Project/OpenROAD/pull/11107) so LEF58_MINWIDTH WRONGDIRECTION parses with trailing whitespace), [OpenFPGA](https://github.com/lnis-uofu/OpenFPGA), and [Verilator](https://github.com/verilator/verilator) ([PR #8070](https://github.com/verilator/verilator/pull/8070) fixing Linux peak memory reporting). I've also built an [8-bit discrete-transistor ALU](https://alu.tmarhguy.com) from first principles. Professionally, I'm interning with [Vero Electric](https://veroelectric.com/) on battery management infrastructure and working with [Aragorn AI](https://www.aragorn.ai/) on production backends and technical documentation. I taught through [Fife-Penn STEM & CS Academy](https://fife.cis.upenn.edu/) and spent Summer 2026 as an AR/VR instructor with [Howard University STEM Achievers](https://education.howard.edu/affiliated-programs/stem-summer-camp-verizon-innovative-learning). For press coverage and a fuller biography, see my [Wikipedia article](${WIKIPEDIA_URL}).
