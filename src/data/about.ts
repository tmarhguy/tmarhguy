...
This fall I'm joining Pennovation to research FPGA utilization, building [Tomato](https://github.com/tmarhguy/tomato) — a custom 32-bit computer from discrete logic through PCB tapeout — and shipping low-latency networking hardware in SystemVerilog. I've also built an [8-bit discrete-transistor ALU](https://alu.tmarhguy.com) from first principles. Professionally, I'm interning with [Vero Electric](https://veroelectric.com/) on battery management infrastructure, and working with [Aragorn AI](https://www.aragorn.ai/) to maintain their backend systems and dynamic technical documentation. For press coverage and a fuller biography, see my [Wikipedia article](https://en.wikipedia.org/wiki/Tyrone_Marhguy).
