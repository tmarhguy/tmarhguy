...
const data: Project[] = [
  ...
  },
  {
    ...
    tech: ['SystemVerilog', 'KiCad', 'SymbiYosys', 'Vivado'],
    category: 'hardware',
    onResume: true,
    featured: true,
  ...
  },
  {
    ...
    tech: ['SystemVerilog', 'OpenLane', 'Sky130', 'cocotb'],
    category: 'hardware',
  },
  {
  ...
  },
  {
    ...
    tech: ['SystemVerilog', 'Artix-7 FPGA', 'C', 'GCC'],
    category: 'hardware',
  },
  {
  ...
  },
  {
    ...
    desc: 'Scripts I reach for to convert video, PDFs, and images locally — wired behind a `mango` terminal menu so I am not uploading files to random websites.',
