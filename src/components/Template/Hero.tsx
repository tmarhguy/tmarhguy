      ...
      <div className="hero-grid">
        <div className="hero-primary">
          ...
          <p className="hero-intro">
            ...
            a <ProjectLink titleMatch="Tomato">32-bit CPU</ProjectLink> that
            rethinks how FPGAs reconfigure. Previously:{' '}
            <ProjectLink titleMatch="SRAM">full-custom SRAM</ProjectLink>,{' '}
            <ProjectLink titleMatch="NASDAQ">
              NASDAQ market data parsers
            </ProjectLink>
            , and a{' '}
