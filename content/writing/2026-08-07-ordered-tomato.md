...
*Figure 1 — What we are actually building: `07_alu` — board render (left), routed top copper (right). DRC clean, 0 unrouted nets.*
...
*Figure 3 — DigiKey order `100884560` — 10 line items, two boards worth of silicon.*
