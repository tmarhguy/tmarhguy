---
title: 'Discard Previewer or Integrate'
date: '2026-09-15'
description: 'There was an enormous wait time to get the fresh bitstream from each iteration, and I thought to instead build a Python previewer which takes that assembly source file, Tomato O...'
project: tomato
image: '/images/os/tomato-virtual-os-envelop-infinix.webp'
imageAlt: 'Envelop open inside Tomato OS in the Virtual Tomato browser emulator on an Infinix phone'
---
...
![Envelop open inside Tomato OS in the Virtual Tomato browser emulator on an Infinix phone](/images/os/tomato-virtual-os-envelop-infinix.webp)

_Browser emulation · current OS image with simulated peripherals and an offline bridge, shown at a real phone viewport; not FPGA hardware._
...
This follows [Synthesis Bypass](/writing/2026-09-14-synthesis-bypass/) and [Envelop — Tomato gets a message app](/writing/2026-09-14-envelop-tomato-gets-a-message-app/).
