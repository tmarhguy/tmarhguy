...
title: 'ISA Upgrade'
date: '2026-09-13'
description: 'Nine new instructions in one evening — naming the three-input ALU operations Tomato could always do, from 52 opcodes to 61.'
project: tomato
image: '/images/logs/isa-upgrade.png'
imageAlt: 'ISA table listing new alu-reg instructions including ANDN, ORN, CSEL, and ANDADD'
---

![ISA table listing new alu-reg instructions including ANDN, ORN, CSEL, and ANDADD](/images/logs/isa-upgrade.png)

Two days ago I wrote that assembly language was hiding half of my own machine from me. Tonight I did something about it. It is the follow-up to [When assembly is still too high-level for Tomato](/writing/2026-09-11-when-assembly-is-still-too-high-level-for-tomato/).
...
That takes the instruction count from 52 to 61.
