...
title: 'Tools'
date: '2026-08-01'
description: 'This project is a centralized, offline repository designed to replace SaaS platforms (like iLovePDF and online image compressors) entirely. By housing my most frequently used ut...'
project: mango
image: '/images/mango/img_comp_window.png'
imageAlt: 'Mango image compression window'
---

**See also:** [Shell UI — Mango](/writing/2026-08-01-shell-ui-mango/) · [Mango — Arrow Navigation & Video Pipeline](/writing/2026-08-03-mango-arrow-navigation-video-pipeline/) · [System-Wide Call](/writing/2026-08-11-system-wide-call/)
...
_This repository is public. The goal is to provide a clean, terminal-based alternative to bloated web utilities, expanding the toolkit as new needs arise._
