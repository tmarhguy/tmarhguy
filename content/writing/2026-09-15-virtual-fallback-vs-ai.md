---
title: 'Virtual Fallback vs AI'
date: '2026-09-15'
description: 'I wondered, what is the use of saying hello to tomato and getting a reponse, Hello {firstname}? It is cool, but withers too quickly. It would be completely orthogonal to build a...'
project: tomato
image: '/images/os/tomato-compute-provenance-desktop.webp'
imageAlt: 'Compute preview showing Ask, Choose the target, and See the result with Virtual Tomato provenance'
---
...
![Compute preview showing Ask, Choose the target, and See the result with Virtual Tomato provenance](/images/os/tomato-compute-provenance-desktop.webp)

_UI documentation · hardware and virtual execution are separate, visibly labeled paths; this capture demonstrates provenance boundaries, not a completed hardware job._
