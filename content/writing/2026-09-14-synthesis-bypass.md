---
title: 'Synthesis Bypass'
date: '2026-09-14'
description: 'I have spent the entire day, and much of that was waiting on synthesis, routing, and bitstream generation! In one case, I took a walk to bike around and after 36 mins, it was st...'
project: tomato
image: '/images/os/tomato-virtual-os-compiler-desktop.webp'
imageAlt: 'Compiler screen running inside Tomato OS in the desktop Virtual Tomato emulator'
---
...
![Compiler screen running inside Tomato OS in the desktop Virtual Tomato emulator](/images/os/tomato-virtual-os-compiler-desktop.webp)

_Browser emulation · the generated OS image in the functional CPU emulator; this preview shortens iteration but is not physical FPGA execution._

This has been a tough friction point, and initially with my frustration with Vivado ([Exploring Beyond Vivado](/writing/2026-08-28-exploring-beyond-vivado-open-source-synthesis-pivot/)), I lamented on the cycle taking forever — but I had not worked with FPGA enough to fully appreciate it if I skipped those layers into, say, a Python preview. But now, I have built sufficient base intuition to skip to Python.
