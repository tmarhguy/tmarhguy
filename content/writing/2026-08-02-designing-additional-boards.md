---
title: 'Designing Additional Boards'
date: '2026-08-02'
...
**Related:** [Falling back to 32b](/writing/2026-07-31-falling-back-to-32b/) · [The lingering catch](/writing/2026-07-31-the-lingering-thoughts/) · 07 ALU board doc
...
That is the plan [from last week](/writing/2026-07-31-the-lingering-thoughts/): while the ALU fab runs, design slices that ship in the final machine instead of a throwaway FSM.
...
2. **Matched decode enables** from the modular control boards — only one driver active per phase, same idea as the [ALU display scan chain](/writing/2026-06-19-alu-segment-display-design/) (one hot index, shared bus).
...
Heat from brief overlap at these speeds should be ok. Production hygiene still matters: **one active driver per bus**, decode timed to the sequencer phases documented in [Load Store Pipeline Analysis](/writing/2026-06-11-load-store-pipeline-analysis/).
