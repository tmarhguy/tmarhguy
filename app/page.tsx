...
import { flagshipProjects, softwareProjects, hardwareProjects } from "@/data/projects";

export default function Home() {
  // Project data is imported from data/projects.ts for better maintainability
    ...
    <main className="min-h-screen bg-background relative">
      ...
      <section id="projects" className="py-6 sm:py-8 px-4 sm:px-6 relative">
        ...
        <div className="container mx-auto relative z-10">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 xl:grid-cols-4 gap-4 sm:gap-6 lg:gap-8 max-w-7xl mx-auto items-stretch">
      ...
      <section className="py-4 sm:py-6 px-4 sm:px-6 relative">
        ...
        <div className="container mx-auto relative z-10">
          ...
          <div className="mt-0">
            <h3 className="text-2xl sm:text-3xl font-bold text-center mb-3 sm:mb-4 text-foreground">
              Software Development
            </h3>
            <p className="text-muted-foreground text-center mb-6 sm:mb-8 max-w-2xl mx-auto px-2">
      ...
      <section id="about" className="py-1 sm:py-2 px-4 sm:px-6 bg-gray-950 relative">
        ...
        <div className="container mx-auto max-w-4xl relative z-10">
          <div className="text-center mb-3 sm:mb-4">
            ...
            <p className="text-lg sm:text-xl text-muted-foreground px-2 mb-6">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-12 items-start">
            <div className="space-y-4 sm:space-y-6">
              <div>
                <h3 className="text-xl sm:text-2xl font-semibold text-foreground mb-3 sm:mb-4">Engineering Philosophy</h3>
              ...
              <div className="bg-surface-dark rounded-lg p-4 sm:p-6 border border-surface">
                ...
                <div className="grid grid-cols-2 gap-3">
                  ...
                  >
                    ...
                    <span className="text-muted-foreground group-hover:text-foreground text-sm">GitHub</span>
                  </a>
                  <a 
                  ...
                  >
                    ...
                    <span className="text-muted-foreground group-hover:text-foreground text-sm">LinkedIn</span>
                  </a>
                  <a 
                  ...
                  >
                    ...
                    <span className="text-muted-foreground group-hover:text-foreground text-sm">Email</span>
                  </a>
                  <a 
                  ...
                  >
                    ...
                    <span className="text-muted-foreground group-hover:text-foreground text-sm">Blog</span>
                  </a>
                </div>
              </div>
              ...
              <div className="bg-surface-dark rounded-lg p-4 sm:p-6 border border-surface">
                ...
                <div className="flex flex-wrap gap-1.5 sm:gap-2">
                  {[
                    ...
                    <span 
                      key={skill}
                      className="px-2 sm:px-3 py-1 bg-brand-600/20 text-brand-600 dark:text-brand-300 text-xs sm:text-sm rounded-full border border-brand-600/30"
                    >
                      {skill}
                    </span>
                  ))}
            ...
            <div className="space-y-4 sm:space-y-6">
              <div>
                <h3 className="text-xl sm:text-2xl font-semibold text-foreground mb-3 sm:mb-4">Resilience & Advocacy</h3>
                <p className="text-muted-foreground leading-relaxed text-sm sm:text-base">
                ...
                <div className="space-y-3 sm:space-y-4">
                  <div className="flex items-center gap-3 sm:gap-4">
                    ...
                    <div>
                      ...
                      <div className="text-muted-foreground text-sm sm:text-base">Computer Engineering at University of Pennsylvania</div>
                    </div>
                  </div>
                  <div className="flex items-center gap-3 sm:gap-4">
                    <div className="w-2 h-2 sm:w-3 sm:h-3 bg-brand-500 rounded-full flex-shrink-0"></div>
                    <div>
                      ...
                      <div className="text-muted-foreground text-sm sm:text-base">8 A1s in WASSCE, Math & Physics Olympiad medals</div>
                    </div>
                  </div>
                  <div className="flex items-center gap-3 sm:gap-4">
                    <div className="w-2 h-2 sm:w-3 sm:h-3 bg-brand-500 rounded-full flex-shrink-0"></div>
                    <div>
                      ...
                      <div className="text-muted-foreground text-sm sm:text-base">High Court victory on student rights</div>
                    </div>
                  </div>
                </div>
              </div>
