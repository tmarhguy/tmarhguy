...
![JLCPCB order confirmation](orders/pcb_order_jlcpcb.png)
_Figure 2 — JLCPCB order — copper incoming._

![JLCPCB checkout](orders/02_jlcpcb.png)
_Figure 3 — JLC order details._

![JLCPCB summary](orders/03_jlcpcb.png)
_Figure 4 — JLC summary._
...
![DigiKey order confirmation](orders/01_digikey.png)
_Figure 5 — DigiKey order `100884560` — 10 line items, two boards worth of silicon._
